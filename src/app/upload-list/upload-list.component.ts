...
b64MarkedImg: any = null; // contains the recieved base64 images
  ...
  displayInfo() {   
    ...
    this.http.post("http://172.23.179.17:5000/api/InfoExtractor  ",this.myJson).subscribe(
      (data: any) => {
    ...
    convertToJpeg(index: number){
        ...
        // IP (Home): 192.168.0.102
        this.http.post("http://172.23.179.17:5000/api/ConvertPDFs",this.myJson).subscribe(
        (data: any) => {
          this.displayInfo();
      }
      );
